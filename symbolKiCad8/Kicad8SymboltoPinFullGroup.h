#ifndef Kicad8SymboltoPinFullGroup_H
#define Kicad8SymboltoPinFullGroup_H
...
class Kicad8SymboltoPinFullGroup
{
public:
    Kicad8SymboltoPinFullGroup();
    ~Kicad8SymboltoPinFullGroup();
...
private:
    ...
    std::set<std::vector<std::string>> fullPinGroup;

public:

    std::string vectorToString(const std::set<std::vector<std::string>>& vec);
...
#endif   // Kicad8SymboltoPinFullGroup_H