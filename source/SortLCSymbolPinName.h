#ifndef SortLCSymbolPinName_H_
#define SortLCSymbolPinName_H_
#include <wx/wx.h>
#include <string>
#include <vector>
#include <wx/string.h>
...
private:
    ...
    std::multimap<std::string, std::string, CompareAlphaNumeric> allPinsInfo;
