#ifndef Kicad8SymboltoTrainTestPin_H
#define Kicad8SymboltoTrainTestPin_H
...
class Kicad8SymboltoTrainTestPin
{
public:
    Kicad8SymboltoTrainTestPin();
    ~Kicad8SymboltoTrainTestPin();
...
#endif   // Kicad8SymboltoTrainTestPin_H